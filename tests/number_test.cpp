...
TEMPLATE_TEST_CASE("numeric limits specialization", "", i8, u8, i16, u16, i32, u32, i64, u64, isize, usize, f32, f64) {
    using inner_t = detail::inner_type_t<TestType>;
    STATIC_REQUIRE(std::numeric_limits<TestType>::is_specialized == std::numeric_limits<inner_t>::is_specialized);
    STATIC_REQUIRE(std::numeric_limits<TestType>::is_signed == std::numeric_limits<inner_t>::is_signed);
    STATIC_REQUIRE(std::numeric_limits<TestType>::is_integer == std::numeric_limits<inner_t>::is_integer);
    STATIC_REQUIRE(std::numeric_limits<TestType>::is_exact == std::numeric_limits<inner_t>::is_exact);
    STATIC_REQUIRE(std::numeric_limits<TestType>::has_infinity == std::numeric_limits<inner_t>::has_infinity);
    STATIC_REQUIRE(std::numeric_limits<TestType>::has_quiet_NaN == std::numeric_limits<inner_t>::has_quiet_NaN);
    STATIC_REQUIRE(std::numeric_limits<TestType>::has_signaling_NaN == std::numeric_limits<inner_t>::has_signaling_NaN);
    STATIC_REQUIRE(std::numeric_limits<TestType>::has_denorm == std::numeric_limits<inner_t>::has_denorm);
    STATIC_REQUIRE(std::numeric_limits<TestType>::has_denorm_loss == std::numeric_limits<inner_t>::has_denorm_loss);
    STATIC_REQUIRE(std::numeric_limits<TestType>::round_style == std::numeric_limits<inner_t>::round_style);
    STATIC_REQUIRE(std::numeric_limits<TestType>::is_iec559 == std::numeric_limits<inner_t>::is_iec559);
    STATIC_REQUIRE(std::numeric_limits<TestType>::is_bounded == std::numeric_limits<inner_t>::is_bounded);
    STATIC_REQUIRE(std::numeric_limits<TestType>::is_modulo == std::numeric_limits<inner_t>::is_modulo);
    STATIC_REQUIRE(std::numeric_limits<TestType>::digits == std::numeric_limits<inner_t>::digits);
    STATIC_REQUIRE(std::numeric_limits<TestType>::digits10 == std::numeric_limits<inner_t>::digits10);
    STATIC_REQUIRE(std::numeric_limits<TestType>::max_digits10 == std::numeric_limits<inner_t>::max_digits10);
    STATIC_REQUIRE(std::numeric_limits<TestType>::radix == std::numeric_limits<inner_t>::radix);
    STATIC_REQUIRE(std::numeric_limits<TestType>::min_exponent == std::numeric_limits<inner_t>::min_exponent);
    STATIC_REQUIRE(std::numeric_limits<TestType>::min_exponent10 == std::numeric_limits<inner_t>::min_exponent10);
    STATIC_REQUIRE(std::numeric_limits<TestType>::max_exponent == std::numeric_limits<inner_t>::max_exponent);
    STATIC_REQUIRE(std::numeric_limits<TestType>::max_exponent10 == std::numeric_limits<inner_t>::max_exponent10);
    STATIC_REQUIRE(std::numeric_limits<TestType>::traps == std::numeric_limits<inner_t>::traps);
    STATIC_REQUIRE(std::numeric_limits<TestType>::tinyness_before == std::numeric_limits<inner_t>::tinyness_before);
    STATIC_REQUIRE(std::numeric_limits<TestType>::min().template as<inner_t>() == std::numeric_limits<inner_t>::min());
    STATIC_REQUIRE(std::numeric_limits<TestType>::lowest().template as<inner_t>() == std::numeric_limits<inner_t>::lowest());
    STATIC_REQUIRE(std::numeric_limits<TestType>::max().template as<inner_t>() == std::numeric_limits<inner_t>::max());
    STATIC_REQUIRE(std::numeric_limits<TestType>::epsilon().template as<inner_t>() == std::numeric_limits<inner_t>::epsilon());
    STATIC_REQUIRE(std::numeric_limits<TestType>::round_error().template as<inner_t>() == std::numeric_limits<inner_t>::round_error());
    STATIC_REQUIRE(std::numeric_limits<TestType>::infinity().template as<inner_t>() == std::numeric_limits<inner_t>::infinity());
    ...
    STATIC_REQUIRE(std::numeric_limits<TestType>::denorm_min().template as<inner_t>() == std::numeric_limits<inner_t>::denorm_min());
}